...
% 18pt body (20pt) so it stands out without dominating the page; centred on
% its own line, with a little air above (separating it from whatever came
% before) and below (before the hymn's own line spacing, sized for the pitch
% marks, takes over).  \line avoids \everypar's hanging indent, which is for
% hymn paragraphs, not headings.
\font\titlefont=phvb8t scaled 2000
\def\title#1{\par\vskip6pt\noindent\line{\hss\titlefont#1\hss}\vskip10pt}
